    ...
    return (
        <div className="os-loader">
            <svg version="1.1" id="Layer_1"
                ...
                xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 57.6 39.1" style="enable-background:new 0 0 57.6 39.1;" xmlSpace="preserve">
                <path id="os-blue" class="os-blue" style="fill: #00246a;" d="M38.4,22c0,0.4-0.3,0.7-0.7,0.7H13.5c-0.4,0-0.7-0.3-0.7-0.7v-1.4c0-0.4,0.3-0.7,0.7-0.7h24.2 c0.4,0,0.7,0.3,0.7,0.7V22z"/>
